...
#ifndef AvidaMetaDriver_h
#define AvidaMetaDriver_h
...
class AvidaMetaDriver : public Avida::WorldDriver
{
protected:
  cWorld* m_worlds[2];
  Avida::World* m_new_worlds[2];
  cGod* m_god;
  bool m_done;
...
public:
  AvidaMetaDriver(cWorld* worlds[1], Avida::World* new_worlds[1], cGod* God);
  ~AvidaMetaDriver();  
